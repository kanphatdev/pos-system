...
try {
    $sql = "SELECT `id`, `fname`, `lname`, `email`, `address`, `phone`, `salary`, `birthday`, `start_date`, `end_date` FROM `users_info`";
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-capitalize">birth day</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-employee.php?id=<?php echo $user['id'] ?>" class="btn btn-outline-warning"><i class="fas fa-pen"></i></a>
                                                    <a href="delete.php?id=<?php echo $user['id'] ?>" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a>
                                                </td>
                                                <!-- Add more columns for other user attributes as needed -->
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
